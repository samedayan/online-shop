...
using Sendeo.OnlineShop.Customer.Api.Extensions;
using Sendeo.OnlineShop.Customer.Api.Filters.Authentication;
using Sendeo.OnlineShop.Customer.Api.Installers;
using Sendeo.OnlineShop.Customer.Api.LifetimeHooks;
using Sendeo.OnlineShop.Customer.Api.Middlewares;
using Sendeo.OnlineShop.Customer.Application.Installers;
